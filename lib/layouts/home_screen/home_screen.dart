      ...
      builder: (context, state) {
        ...
        return Form(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              title: Text(_cubit.homeScreensTitles[_cubit.currentIndex]),
            ),
            bottomNavigationBar: BottomNavigationBar(
              ...
              items: const [
                BottomNavigationBarItem(
                    label: "Tasks", icon: Icon(Icons.event_note)),
                BottomNavigationBarItem(
                    label: "Done", icon: Icon(Icons.cloud_done)),
                BottomNavigationBarItem(
              ...
              onPressed: () {
                ...
                if (_cubit.bottomSheetShown == true) {
                  if (_formState.currentState!
                      .validate()) // if validator return null
                  {
