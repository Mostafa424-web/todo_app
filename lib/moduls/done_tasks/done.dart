  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit,AppStates>(
      ...
      builder: (context,state){
        ...
        return
          _cubit.doneTasks.isEmpty? const Center(child:  Icon(Icons.cloud_done_outlined,size: 35,color: Colors.grey,)) :
          Container(
            ...
            child: ListView.separated(
                        ...
                        [
                          SizedBox(
                            ...
                            child: CircleAvatar(
                              ...
                              maxRadius: 30,
                              child:Text("${_cubit.doneTasks[i]['time']}",style: const TextStyle(fontSize: 10),),
                            ),
                          ),
              ...
              separatorBuilder: (context,i)=> Container
                ...
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(25),color: const Color.fromARGB(255, 100, 138, 130).withAlpha(50),),
